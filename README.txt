...
a persistence unit "HotelUtitlityPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "HotelUtitlity/pom.xml":
...
artifacts ("HotelUtitlity-ejb.jar" and "HotelUtitlity-web.war") are already built. You can build
